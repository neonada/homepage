  ...
  return (
    <div>
      ...
      <div className="join-us">
        <NavLink className="join-us-img" to="/JoinUs"><img src={joinUs} alt=""></img></NavLink>
        <NavLink className="join-us-img-mobile" to="/JoinUs"><img src={joinUsMobile} alt=""></img></NavLink>
        <div className="join-us-content">
          ...
          <NavLink to="/JoinUs"  className="join-us-link">OPEN POSITIONS</NavLink>
        </div>
      </div>

      <div className="invest">
        <NavLink className="invest-img" to="/Invest"><img src={invest} alt=""></img></NavLink>
        <NavLink className="invest-img-mobile" to="/Invest"><img src={investMobile} alt=""></img></NavLink>
        <div className="invest-content">
          <p style={{margin:"0", marginBottom:"16px"}}>
            Don't miss opportunity to make an impact. Be an angel and let's
            create new stories!
          </p>
          <NavLink to="/Invest" className="invest-link">GET IN TOUCH</NavLink> 
        </div>
      </div>
    </div>
  );
